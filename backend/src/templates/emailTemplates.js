export const getTemplateBoasVindas = () => {
  return `
<!DOCTYPE html>
            <html lang="pt-BR">
            <head>
...
export const getTextoBoasVindas = () => {
  return "Que bom ter você por aqui! Seu e-mail foi cadastrado com sucesso na nossa newsletter oficial do OneDevs OS.";
};
